Feature: School Admin Role Page Functionality
    As a user
...
#     #     Then Enter the Search - Record Id in search box and Verify the Result of rb
    ...
    Scenario: Repair360  -repairTicket
        And Click on Repair360 page
    ...
    Scenario:Repair360 create, search and filters InHouseRepairCenter
        # Then Click on Repair360 page
...
Scenario:Repair360 create, search and filters  StudentRepairCenter
        Then Click on Repair360 page
