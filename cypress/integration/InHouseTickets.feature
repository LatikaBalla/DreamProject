Feature:InHouseTickets Page Functionality
  ...
  Scenario: Visiblity check, Create a ticket and download export
    ...
    # And Click on filter of Record Id Greater than in search box and Verify the Result
    # And Click on filter of Record Id Greater than or equal to in search box and Verify the Result
    # And Click on filter of Record Id Less than in search box and Verify the Result
    # And Click on filter of Record Id Less than or equal to in search box and Verify the Result
    # And Click on filter of Record Id Between in search box and Verify the Result
