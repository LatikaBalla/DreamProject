Feature: Building Admin Role  Page Functionality
    As a user
    ...
    Scenario: Building Admin Role can access the dashboard page and check the visiblity
    ...
    Scenario: Manage device: ImportSerialDevices, OrgUploadAssets
        And Click on ManageDevices page
 ...
 Scenario: Manage device: LoanerManagement
          And Click on ManageDevices page
    ...
    Scenario:Repair360 -InHouseWorkflow
        Then Click on Repair360 page
 ...
 Scenario:Repair360 -InHouseRepairCenter
    ...
    Scenario: Repair360- SrcRepairTickets
        Then Click on Repair360 page
    ...
    Scenario: Repair360- SrcFacilitators , SrcStudents
        Then Click on Repair360 page
        And Click on StudentRepairCenter tab
