Feature: Facilitator Role  Page Functionality
    As a user
    ...
    Scenario: Facilitator can access the dashboard page and check the visiblity
    ...
    Scenario: Report center- DeviceRepairReport
        And Click on Report center page
    ...
    Scenario: Report center -NonwarrantyRepairs
        And Click on Report center page
